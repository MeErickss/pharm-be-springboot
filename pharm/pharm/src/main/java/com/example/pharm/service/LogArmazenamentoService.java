...
public class LogArmazenamentoService {
    ...
    public LogArmazenamento insertLogArmazenamento(String userLogin, Long parametroId, String descricao) {
        return insertLogArmazenamento(userLogin, parametroId, null, null);
    }
